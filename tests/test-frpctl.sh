...
grep -q 'Project version : 1.3.0' "$WORKDIR/client-menu.out" || fail "client menu version"
...
grep -q 'Project version : 1.3.0' "$WORKDIR/client-repl.out" || fail "client repl version"
